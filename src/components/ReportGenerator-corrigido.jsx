      ...
      reportElement.innerHTML = `
        <div style="border: 2px solid #000; padding: 20px;">
          ...
          <div style="display: flex; gap: 10px; margin-bottom: 20px;">
            ...
            <div style="border: 1px solid #000; padding: 5px; width: 80px;">
              <strong>HP:</strong> ${formData.hp || '08:03'}
            </div>
          ...
          <div style="margin-bottom: 20px;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
              <thead>
                <tr>
                  <th style="border: 1px solid #000; padding: 5px; background-color: #f0f0f0; width: 50%;">Horário</th>
                  <th style="border: 1px solid #000; padding: 5px; background-color: #f0f0f0; width: 50%;">Resultado</th>
                </tr>
                <tr>
              ...
              <tbody>
                ${formData.testeZeroGraos?.map(teste => `
                  <tr>
