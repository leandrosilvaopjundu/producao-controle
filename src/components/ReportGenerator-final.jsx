    ...
    try {
      ...
      reportElement.innerHTML = `
        <div style="border: 2px solid #000; padding: 20px;">
          ...
          <!-- Teste Zero Grão - Layout Otimizado -->
          <div style="margin-bottom: 20px;">
            <div style="text-align: center; font-weight: bold; margin-bottom: 10px;">Teste Zero Grão</div>
            <table style="width: 100%; border-collapse: collapse;">
              <thead>
                <tr>
                  <th style="border: 1px solid #000; padding: 5px; background-color: #f0f0f0; width: 12.5%;">Horário</th>
                  <th style="border: 1px solid #000; padding: 5px; background-color: #f0f0f0; width: 12.5%;">Resultado</th>
                  <th style="border: 1px solid #000; padding: 5px; background-color: #f0f0f0; width: 12.5%;">Horário</th>
                  <th style="border: 1px solid #000; padding: 5px; background-color: #f0f0f0; width: 12.5%;">Resultado</th>
                  <th style="border: 1px solid #000; padding: 5px; background-color: #f0f0f0; width: 12.5%;">Horário</th>
                  <th style="border: 1px solid #000; padding: 5px; background-color: #f0f0f0; width: 12.5%;">Resultado</th>
                ...
                <tr>
                  ...
                  <th style="border: 1px solid #000; padding: 5px; background-color: #f0f0f0;">OK / R</th>
                  <th style="border: 1px solid #000; padding: 5px; background-color: #f0f0f0;"></th>
                  <th style="border: 1px solid #000; padding: 5px; background-color: #f0f0f0;">OK / R</th>
                  <th style="border: 1px solid #000; padding: 5px; background-color: #f0f0f0;"></th>
                  <th style="border: 1px solid #000; padding: 5px; background-color: #f0f0f0;">OK / R</th>
              ...
              <tbody>
                ${(() => {
                  if (!formData.testeZeroGraos || formData.testeZeroGraos.length === 0) {
                    // Se não há testes, mostrar apenas 3 linhas vazias
                  ...
                  // Organizar testes em grupos de 4 por linha (4 colunas de horário/resultado)
                  const testes = formData.testeZeroGraos
                  const linhas = []
                  
                  for (let i = 0; i < testes.length; i += 4) {
                    const testesLinha = testes.slice(i, i + 4)
                    let linha = '<tr>'
                    
                    // Preencher até 4 colunas por linha
                    for (let j = 0; j < 4; j++) {
                      if (testesLinha[j]) {
                        linha += `
                          <td style="border: 1px solid #000; padding: 5px; text-align: center;">${testesLinha[j].horario}</td>
                          <td style="border: 1px solid #000; padding: 5px; text-align: center;">${testesLinha[j].status}</td>
                        `
                      } else {
                        linha += `
                          <td style="border: 1px solid #000; padding: 5px;"></td>
